...
try {
    ...
    if (!empty($_POST['queryString'])) {
        $query = str_replace("1=1", 
        "(
            fullname like '%" . $_POST['queryString'] . "%' 
            or  phonenumber like '%" . $_POST['queryString'] . "%' 
            or  guardianphonenumber like '%" . $_POST['queryString'] . "%' 
            or  governorate like '%" . $_POST['queryString'] . "%' 
            or  g.name like '%" . $_POST['queryString'] . "%' 
            or  st.name like '%" . $_POST['queryString'] . "%' 
            or  email like '%" . $_POST['queryString'] . "%' 
        ) and 1=1", $query);
    }
