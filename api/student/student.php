...
try {
    ...
    if (!empty($_POST['queryString']))$query = str_replace("1=1", "fullname like '%" . $_POST['queryString']  . "%' and 1=1", $query);
    if (!empty($_POST['startIndex']))$query = str_replace("1=1", " ss.id >= " . $_POST['startIndex'] . " and 1=1", $query);
    if (!empty($_POST['lastIndex']))$query = str_replace("1=1", " ss.id <= " . $_POST['lastIndex'], $query);
